...
class myUnet(object):
	...
	def __init__(self, img_rows = 496, img_cols = 512):
	...
	def train(self):
		...
		print('Fitting model...')
		model.fit(imgs_train, imgs_mask_train, batch_size=5, epochs=3, verbose=1)
...
endtime = time.clock()
print("The training and testing running time is %g s" % (endtime-starttime))
