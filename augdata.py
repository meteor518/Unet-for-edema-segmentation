...
class myAugmentation(object):
	...
	def __init__(self, train_path="train", label_path="label", merge_path="merge", aug_merge_path="aug_merge", aug_train_path="aug_train", aug_label_path="aug_label", img_type="jpg"):

		"""
		Using glob to get all .img_type form path
		"""
		dirtype = ("merge","aug_merge", "aug_train", "aug_label")
	...
	def doAugmentate(self, img, save_to_dir, save_prefix, batch_size=1, save_format='jpg', imgnum=10):
...
endtime = time.clock()
print("The augdata running time is %g s" %(endtime-starttime))
